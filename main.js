...
// // document.title = "I don't know!"
// console.log(document.doctype);
// console.log(document.head);
// console.log(document.body);
// console.log(document.all);
// // document.all[9].textContent = "What";
// console.log(document.forms);
// console.log(document.links);
// console.log(document.body);
// console.log(document.images);

/* input.value to add value to input[type="text"] */
...
// // Add attr
// new_div.setAttribute("title", "This is New Div");

// // create text node
// var new_text_node = document.createTextNode("Item nth");
...
// var last_item = document.querySelectorAll(".list-group-item");

// // items_container.insertAfter(new_div, last_item[last_item.length - 1]);
// insertAfter(items_container, last_item[last_item.length - 1], new_div);
